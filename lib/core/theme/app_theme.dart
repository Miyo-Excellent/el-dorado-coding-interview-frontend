...
abstract final class AppDecorations {
  ...
  static BoxDecoration wealthCard = BoxDecoration(
    ...
    gradient: const LinearGradient(
      ...
      colors: [
        Color(0xFF1A1A00), // very subtle golden tint
...
// -----------------------------------------------------------------------------
// § 9 · PUBLIC API — buildAppTheme()
// -----------------------------------------------------------------------------

/// Builds and returns the complete [ThemeData] for El Dorado.
///
/// Call once in `MaterialApp.theme`. This is the **single source of truth**
/// for all visual token configuration.
///
/// ```dart
/// MaterialApp.router(
///   theme: buildAppTheme(),
