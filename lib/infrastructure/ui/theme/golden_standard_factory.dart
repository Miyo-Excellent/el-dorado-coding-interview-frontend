...
class GoldenStandardLightColors extends AppColorTokens {
  ...
  @override Color get primaryContainer => const Color(0xFFFFB400);
  @override Color get onPrimaryContainer => const Color(0xFF191C1D);
  @override Color get secondary => const Color(0xFFE0F7FA);
  @override Color get onSecondary => const Color(0xFF191C1D);
  ...
  @override Color get tertiary => const Color(0xFF28A745);
  ...
  @override Color get surface => const Color(0xFFE0F7FA);
...
class GoldenStandardDarkColors extends AppColorTokens {
  ...
  @override Color get surface => const Color(0xFF191C1D);
  @override Color get onSurface => const Color(0xFFE0F7FA);
  @override Color get onSurfaceVariant => const Color(0xFFE0F7FA).withValues(alpha: 0.7);
